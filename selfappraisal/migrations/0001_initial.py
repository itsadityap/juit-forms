    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_designation', models.CharField(max_length=100)),
                ('present_pay_scale_and_pay', models.CharField(max_length=100)),
                ('areas_of_specialization', models.CharField(max_length=100)),
                ('additional_qualifications', models.CharField(max_length=100)),
                ('pursuing_higher_studies', models.CharField(max_length=100)),
